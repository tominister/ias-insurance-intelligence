...
```powershell
git clone https://github.com/tominister/ias-insurance-intelligence.git
...
| Repo | Pattern |
|------|---------|
| [ias-insurance-intelligence](https://github.com/tominister/ias-insurance-intelligence) | Structured data assistant (this repo) |
| [ias-loan-agreement-extraction](https://github.com/tominister/ias-loan-agreement-extraction) | RAG document extraction |
