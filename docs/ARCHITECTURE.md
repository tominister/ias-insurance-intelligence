...
**GitHub mirror:** [tominister/ias-insurance-intelligence](https://github.com/tominister/ias-insurance-intelligence-revantage) — sanitized portfolio; see [SOURCE_AND_PORTFOLIO.md](SOURCE_AND_PORTFOLIO.md)  
...
This is **not RAG**. There is no vector store, no document chunking, and no embedding retrieval over unstructured text. Compare with [ias-loan-agreement-extraction](https://github.com/tominister/ias-loan-agreement-extraction-revantage), which *is* RAG.
